#!/bin/bash
#SBATCH --job-name=1baseline_glove_original
...
python3 main.py --parameters_filepath /gpfs/home/bsc88/bsc88251/experiments/1baseline_glove_original/1baseline_glove_original_parameters.ini
