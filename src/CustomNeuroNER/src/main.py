    ...
    for k,v in parameters.items():
        ...
        if k in ['character_embedding_dimension','character_lstm_hidden_state_dimension','token_embedding_dimension',
            ...
            parameters[k] = float(v)
                 ...
                 'check_for_lowercase', 'check_for_digits_replaced_with_zeros', 'freeze_token_embeddings', 'load_only_pretrained_token_embeddings', 'use_pos', 'freeze_pos', 'use_gaz', 'freeze_gaz', 'use_aff','freeze_aff']:
...
def parse_arguments(arguments=None):
    ...
    parser.add_argument('--use_aff', required=False, default=argument_default_value, help='')
    parser.add_argument('--freeze_aff', required=False, default=argument_default_value, help='')
    parser.add_argument('--aff_filepath', required=False, default=argument_default_value, help='')
