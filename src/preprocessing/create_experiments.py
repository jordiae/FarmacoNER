...
def create_experiments2():
    ...
    def create_experiment(experiment):
        ...
        if experiment.pos:
            parameters['use_pos'] = True
            parameters['tokenizer'] = 'pos'

        if experiment.augmentation:
            dataset_text_folder += '-augmented-subset'
...
def create_experiments3():
    EXPERIMENTS_PATH3 = os.path.join('..','..','experiments3')
    if not os.path.exists(EXPERIMENTS_PATH3):
        os.makedirs(EXPERIMENTS_PATH3)
    print('Creating experiments 3...')
    Experiment = collections.namedtuple('Experiment',['name','pos','augmentation','gazetteer'])
    def create_experiment(experiment):
        parameters = {'pretrained_model_folder':'../trained_models/conll_2003_en',
                      'dataset_text_folder':'../data/conll2003/en',
                      ...
                      'freeze_gaz': False,
                      'gaz_filepath':'/gpfs/scratch/bsc88/bsc88251/data/gazetteer/principio_activo_gazetteer.txt'}
        parameters_filepath = '/gpfs/scratch/bsc88/bsc88251/experiments3/' + experiment.name + '/' + experiment.name + '_parameters.ini'
        output_folder = '/gpfs/scratch/bsc88/bsc88251/experiments3/' + experiment.name + '/' + experiment.name + '_output'
        dataset_text_folder = '/gpfs/scratch/bsc88/bsc88251/data/' + experiment.name + '/farmacos-final-one-stratified-split-only-no-norm'
        token_pretrained_embedding_filepath = '/gpfs/scratch/bsc88/bsc88251/data/word_vectors/' + 'Scielo_Fasttext.vec'
...
'''.format(**parameters)
        script = {'jobname': 'conll2003_debug',
                ...
                'parameters_filepath': parameters_filepath}
        script['debug'] = ''
        script['output'] = '/gpfs/scratch/bsc88/bsc88251/experiments3/' + experiment.name + '/' + experiment.name + '.out'
        script['error'] = '/gpfs/scratch/bsc88/bsc88251/experiments3/' + experiment.name + '/' + experiment.name + '.err'
        script['jobname'] = experiment.name
        if experiment.pos:
            script['cpuspertask'] = 48
...
'''.format(**script)
        ...
        EXPERIMENTS_PATH3 = os.path.join('..','..','experiments3')
        experiment_path = os.path.join(EXPERIMENTS_PATH3,experiment.name)
        if os.path.exists(experiment_path):
            print('Experiment',experiment_path,'already exists!')
            exit()
        else:
    ...
    # NO-NORMALIZABLES
    create_experiment(Experiment(name='17NON_PYAYGY', pos = True, augmentation = True, gazetteer = True))

    create_experiment(Experiment(name='18NON_PYANGY', pos = True, augmentation = False, gazetteer = True))

    create_experiment(Experiment(name='19NON_PYANGN', pos = True, augmentation = False, gazetteer = False))

    create_experiment(Experiment(name='20NON_PNAYGY', pos = False, augmentation = True, gazetteer = True))

    create_experiment(Experiment(name='21NON_PNANGY', pos = False, augmentation = False, gazetteer = True))

    create_experiment(Experiment(name='22NON_PNANGN', pos = False, augmentation = False, gazetteer = False))

    create_experiment(Experiment(name='23NON_PNAYGN', pos = False, augmentation = True, gazetteer = False))

    create_experiment(Experiment(name='24NON_PYAYGN', pos = True, augmentation = True, gazetteer = False))


def create_experiments4():
    EXPERIMENTS_PATH4 = os.path.join('..','..','experiments4')
    if not os.path.exists(EXPERIMENTS_PATH4):
        os.makedirs(EXPERIMENTS_PATH4)
    print('Creating experiments 4...')
    Experiment = collections.namedtuple('Experiment',['name','pos','gazetteer'])
    def create_experiment(experiment):
        parameters = {'pretrained_model_folder':'../trained_models/conll_2003_en',
                      'dataset_text_folder':'../data/conll2003/en',
                      'character_embedding_dimension':25,
                      ...
                      'freeze_gaz': False,
                      'gaz_filepath':'/gpfs/scratch/bsc88/bsc88251/data/gazetteer/principio_activo_gazetteer.txt'}
        parameters_filepath = '/gpfs/scratch/bsc88/bsc88251/experiments4/' + experiment.name + '/' + experiment.name + '_parameters.ini'
        output_folder = '/gpfs/scratch/bsc88/bsc88251/experiments4/' + experiment.name + '/' + experiment.name + '_output'
        dataset_text_folder = '/gpfs/scratch/bsc88/bsc88251/data/' + experiment.name + '/farmacos-final-one-stratified-split-only-unclear'
        token_pretrained_embedding_filepath = '/gpfs/scratch/bsc88/bsc88251/data/word_vectors/' + 'Scielo_Fasttext.vec'
...
'''.format(**parameters)
        script = {'jobname': 'conll2003_debug',
                ...
                'parameters_filepath': parameters_filepath}
        script['debug'] = ''
        script['output'] = '/gpfs/scratch/bsc88/bsc88251/experiments4/' + experiment.name + '/' + experiment.name + '.out'
        script['error'] = '/gpfs/scratch/bsc88/bsc88251/experiments4/' + experiment.name + '/' + experiment.name + '.err'
        script['jobname'] = experiment.name
        if experiment.pos:
            script['cpuspertask'] = 48
...
'''.format(**script)
        ...
        EXPERIMENTS_PATH3 = os.path.join('..','..','experiments4')
        experiment_path = os.path.join(EXPERIMENTS_PATH3,experiment.name)
        if os.path.exists(experiment_path):
            print('Experiment',experiment_path,'already exists!')
            exit()
    ...
    # UNCLEAR
    create_experiment(Experiment(name='25U_PYGY', pos = True, gazetteer = True))

    create_experiment(Experiment(name='26U_PYGN', pos = True, gazetteer = False))

    create_experiment(Experiment(name='27U_PNGY', pos = False, gazetteer = True))

    create_experiment(Experiment(name='28U_PNGN', pos = False, gazetteer = False))
